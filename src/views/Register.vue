  ...
  <div class="auth-page main-container">
    ...
    <form @submit.prevent="register">
      <div class="form-group">
        ...
        <input type="text" v-model="firstName" placeholder="Иван" id="firstName" required />
      </div>
      <div class="form-group">
        <label for="lastName">Фамилия</label>
        <input type="text" v-model="lastName" placeholder="Иванов" id="lastName" required />
      </div>
      <div class="form-group">
        <label for="phone">Телефон</label>
        <input type="tel" v-model="phone" placeholder="+7 (123) 456-78-90" id="phone" required />
      </div>
      <div class="form-group">
        <label for="email">Логин (Email)</label>
        <input type="email" v-model="email" placeholder="exampl@gmail.com" id="email" required />
      </div>
      <div class="form-group">
        <label for="address">Адрес</label>
        <input type="text" v-model="address" placeholder="123 Main St, Anytown, USA" id="address" required />
      </div>
      <div class="form-group">
      ...
      <div class="form-group remember-me">
        ...
        <label for="agreement" style="color: #93A0B9;">Принимаю пользовательское соглашение</label>
      </div>
